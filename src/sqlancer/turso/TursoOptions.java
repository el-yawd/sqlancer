...
@Parameters(separators = "=", commandDescription = "Turso")
public class TursoOptions implements DBMSSpecificOptions<TursoOracleFactory> {
    ...
    public TursoOracleFactory oracles = TursoOracleFactory.NoREC;
    ...
    @Override
    public List<TursoOracleFactory> getTestOracleFactory() {
