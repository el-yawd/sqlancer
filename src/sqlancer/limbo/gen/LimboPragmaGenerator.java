...
public class LimboPragmaGenerator {
    ...
    public SQLQueryAdapter insert(LimboGlobalState globalState) {
    ...
    public static SQLQueryAdapter insertPragma(LimboGlobalState globalState)
        throws SQLException {
