...
public class LimboVirtualFTSTableCommandGenerator {
    ...
    public static SQLQueryAdapter create(LimboGlobalState globalState) {
        return new LimboVirtualFTSTableCommandGenerator(globalState.getSchema(), globalState.getRandomly())
                .generate();
    }

    public LimboVirtualFTSTableCommandGenerator(LimboSchema s, Randomly r) {
        this.s = s;
        this.r = r;
    }
    ...
    private SQLQueryAdapter generate() {
        ...
        LimboTable vTable = s.getRandomTableOrBailout(t -> t.isVirtual() && t.getName().startsWith("vt"));
