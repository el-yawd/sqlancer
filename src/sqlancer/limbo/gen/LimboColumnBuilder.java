...
public class LimboColumnBuilder {
    ...
    public String createColumn(String columnName, LimboGlobalState globalState, List<LimboColumn> columns) {
        if (globalState.getDbmsSpecificOptions().oracles == LimboOracleFactory.PQS
    ...
    public LimboColumnBuilder allowCheck(boolean allowCheck) {
