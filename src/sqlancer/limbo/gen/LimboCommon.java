...
public final class LimboCommon {
    ...
    public static String getCheckConstraint(
        ...
        LimboExpression expression = new LimboExpressionGenerator(globalState)
            .setColumns(columns)
            .generateExpression();
    ...
    public static String getOrderingTerm(
        ...
        LimboExpression randExpr = new LimboExpressionGenerator(globalState)
            .setColumns(columns)
            .generateExpression();
    ...
    public static String getOrderByAsString(
        ...
        StringBuilder sb = new StringBuilder();
        LimboExpressionGenerator gen = new LimboExpressionGenerator(
            globalState
        ).setColumns(columns);
        sb.append(" ORDER BY ");
    ...
    public static List<LimboExpression> getOrderBy(
        List<LimboColumn> columns,
        LimboGlobalState globalState
    ) {
        LimboExpressionGenerator gen = new LimboExpressionGenerator(
    ...
    public static List<LimboExpression> getTableRefs(
        List<LimboTable> tables,
        LimboSchema s
    ) {
