...
public class LimboCreateVirtualFTSTableGenerator {

    private final String tableName;
    private final Randomly r;
    private final StringBuilder sb = new StringBuilder();

    public LimboCreateVirtualFTSTableGenerator(String tableName, Randomly r) {
    ...
    public static SQLQueryAdapter createTableStatement(String tableName, Randomly r) {
        return new LimboCreateVirtualFTSTableGenerator(tableName, r).create();
    }
